...
label dialog2:
    ...
    gg "..."
    menu:
        pox "Неужели вы хотите, чтобы такая девушка как я осталась в одиночестве?"

        "Составить компанию":
            gg "Вы настолько очаровательная девушка, что вам невозможно отказать"
            pox '''Наконец-то нашелся достойный мужчина мне в мужья
        ...
        "Покинуть комнату":
            ...
            pox "Очень жаль, а мне хотелось всего лишь быть любимой и счастливой со своим близким человеком"
            jump dialog3

### РОМАНТИЧЕСКАЯ КОНЦОВКА (ОСТАЛСЯ В ЗАТОЧЕНИИ У ЖЕНЩИНЫ LOL)
label romantic:
    scene bg wedding
    with fade
    "конец"
