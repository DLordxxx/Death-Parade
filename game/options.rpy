...
define config.name = _("Mortiferum Hotel")
...
BeyondChivalry - r e l a x i n g

Отдельная благодарность ютуб-каналу:

Космический Кот - RenPy (https://www.youtube.com/channel/UCWJ_pUkd4-oFSr8HPaCuUkw/featured)
""")
...
define build.name = "Mortiferum Hotel"
...
define config.save_directory = "Novel-1653149420"
...
define config.window_icon = "gui/Mortiferum Hotel.png"
